...
from locales.de import TRANSLATIONS as DE
from locales.es import TRANSLATIONS as ES
from locales.fr import TRANSLATIONS as FR
...
class App(ctk.CTk):
    ...
    def refresh_ui_texts(self):
        ...
        self.quick_select_label.configure(
            text=self.t(
                "quick_select"
            )
        )
    ...
    def build_ui(self):
        ...
        self.title_label = (
            ctk.CTkLabel(
                header_frame,
                text=(
                    "Alex Audio Converter"
                ),
                font=(
                    "Arial",
                    self.main_title_size,
                    "bold",
                ),
            )
        )
    ...
    def build_basic_tab(self):
        self.basic_tab.grid_columnconfigure(
            0,
            weight=1,
        )

        self.quick_select_label = (
            ctk.CTkLabel(
                self.basic_tab,
                text=self.t(
                    "quick_select"
        ...
        image_map = {
            "Car Standard":
                "assets/car_standard.png",

            "Car Premium":
                "assets/car_premium.png",

            "Fast Original":
                "assets/fast_original.png",
